export const COUNTRY_COORDS: Record<string, [number, number]> = {
	...
	AT: [47.33, 13.33], AU: [-27.0, 133.0], AZ: [40.5, 47.5],
	BA: [44.0, 17.5], BB: [13.17, -59.53], BD: [24.0, 90.0], BE: [50.83, 4.0],
	BF: [13.0, -2.0], BG: [43.0, 25.0], BH: [26.0, 50.55], BI: [-3.5, 30.0],
	BJ: [9.5, 2.25], BN: [4.5, 114.67], BO: [-17.0, -65.0], BR: [-10.0, -55.0],
	BS: [24.25, -76.0], BT: [27.5, 90.5], BW: [-22.0, 24.0], BY: [53.0, 28.0],
	BZ: [17.25, -88.75], CA: [60.0, -95.0], CD: [0.0, 25.0], CF: [7.0, 21.0],
	CG: [-1.0, 15.0], CH: [47.0, 8.0], CI: [8.0, -5.0], CL: [-30.0, -71.0],
	CM: [6.0, 12.0], CN: [35.0, 105.0], CO: [4.0, -72.0], CR: [10.0, -84.0],
	CU: [21.5, -80.0], CV: [16.0, -24.0], CY: [35.0, 33.0], CZ: [49.75, 15.5],
	...
	KP: [40.0, 127.0], KR: [37.0, 127.5], KW: [29.34, 47.66], KZ: [48.0, 68.0],
	LA: [18.0, 105.0], LB: [33.83, 35.83], LC: [13.88, -60.97], LI: [47.27, 9.53],
	...
	MN: [46.0, 105.0], MR: [20.0, -12.0], MT: [35.83, 14.58], MU: [-20.29, 57.55],
	...
	RW: [-2.0, 30.0], SA: [25.0, 45.0], SB: [-8.0, 159.0], SC: [-4.62, 55.45],
	SD: [15.0, 30.0], SE: [62.0, 15.0], SG: [1.37, 103.8], SI: [46.12, 14.82],
	SK: [48.67, 19.5], SL: [8.5, -11.5], SM: [43.77, 12.42], SN: [14.0, -14.0],
	...
	TT: [11.0, -61.0], TV: [-8.0, 178.0], TZ: [-6.0, 35.0], UA: [49.0, 32.0],
	UG: [1.0, 32.0], US: [38.0, -97.0], UY: [-33.0, -56.0], UZ: [41.0, 64.0],
	VA: [41.9, 12.45], VC: [13.25, -61.2], VE: [8.0, -66.0], VN: [16.0, 106.0],
	VU: [-16.0, 167.0], WS: [-13.58, -172.33], YE: [15.0, 48.0], ZA: [-29.0, 25.0],
